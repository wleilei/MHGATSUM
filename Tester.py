# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 10:34:07 2021
...
class SLTester(TestPipLine):
    ...
    def evaluation(self, G, index, dataset, blocking=False):
        ...
        G.ndata["loss"] = self.criterion(outputs, label).unsqueeze(-1)    # [n_nodes, 1]
        ...
        for j in range(len(glist)):
            ...
            label = g.ndata["label"].sum(-1).squeeze().cpu()    # [n_node]
            if self.m == 0:
