# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 14:43:06 2021
...
class HANLayer(nn.Module):
    ...
    def forward(self, gs, h):
        ...
        for i, j in enumerate(gs.canonical_etypes):
            g=dgl.edge_type_subgraph(gs,[j])
            g = dgl.add_self_loop(g) #A common practice to avoid this is to add a self-loop for each node in the graph if it is homogeneous
